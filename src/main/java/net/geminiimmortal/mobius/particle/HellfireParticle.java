...
public class HellfireParticle extends SpriteTexturedParticle {
    public HellfireParticle(ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
