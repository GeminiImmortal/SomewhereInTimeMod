...
import net.geminiimmortal.mobius.entity.custom.StrangewoodBoatEntity;
...
public class StrangewoodBoatItem extends BoatItem {
    private static final Predicate<Entity> ENTITY_PREDICATE;
    private final String woodType;

    public StrangewoodBoatItem(Properties p_i48526_2_, String woodType) {
    ...
    public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_) {
        ...
        if (((RayTraceResult)lvt_5_1_).getType() == RayTraceResult.Type.MISS) {
            ...
            if (((RayTraceResult)lvt_5_1_).getType() == RayTraceResult.Type.BLOCK) {
                StrangewoodBoatEntity boatEntity = new StrangewoodBoatEntity(p_77659_1_, ((RayTraceResult)lvt_5_1_).getLocation().x, ((RayTraceResult)lvt_5_1_).getLocation().y, ((RayTraceResult)lvt_5_1_).getLocation().z);
