...
import net.geminiimmortal.mobius.entity.custom.GloamthornBoatEntity;
...
public class GloamthornBoatItem extends BoatItem {
    private static final Predicate<Entity> ENTITY_PREDICATE;
    private final String woodType;

    public GloamthornBoatItem(Properties p_i48526_2_, String woodType) {
    ...
    public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_) {
        ...
        if (((RayTraceResult)lvt_5_1_).getType() == RayTraceResult.Type.MISS) {
            ...
            if (((RayTraceResult)lvt_5_1_).getType() == RayTraceResult.Type.BLOCK) {
                GloamthornBoatEntity boatEntity = new GloamthornBoatEntity(p_77659_1_, ((RayTraceResult)lvt_5_1_).getLocation().x, ((RayTraceResult)lvt_5_1_).getLocation().y, ((RayTraceResult)lvt_5_1_).getLocation().z);
