...
public class ModItems {
    ...
    public static final RegistryObject<Item> GOVERNOR_CREST = ITEMS.register("governor_crest", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MISC).stacksTo(1).rarity(Rarity.RARE)));
