...
public class BloodstoneBlobFeature extends Feature<NoFeatureConfig> {

    private final BlockState blockToPlace;

    public BloodstoneBlobFeature(Codec<NoFeatureConfig> codec, BlockState blockToPlace) {
        super(codec);
    ...
    public boolean place(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
        ...
        if (ground.getBlock() != ModBlocks.HEMATITE.get()) {
            return false;
        }
                    ...
                    if (distance <= radius + 0.5) {
                        ...
                        if (!world.isEmptyBlock(placePos)) {
                            ...
                            if (random.nextInt(10) == 7) {
                                world.setBlock(placePos, ModBlocks.BLOODSTONE_GEM_ORE.get().defaultBlockState(), 1);
                            }
                        }
                    }
                }
