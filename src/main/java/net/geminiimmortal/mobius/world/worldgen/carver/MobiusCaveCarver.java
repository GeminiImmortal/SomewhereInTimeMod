...
public class MobiusCaveCarver extends WorldCarver<ProbabilityConfig> {
    public MobiusCaveCarver(Codec<ProbabilityConfig> p_i231917_1_, int p_i231917_2_) {
        super(p_i231917_1_, p_i231917_2_);
    }

    @Override
    protected boolean canReplaceBlock(BlockState state) {
        return state.getBlock() == ModBlocks.HEMATITE.get();
    }
