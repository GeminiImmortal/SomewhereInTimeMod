...
public class ModOreFeatureConfig implements IFeatureConfig {
    ...
    public ModOreFeatureConfig(RuleTest p_i241989_1_, BlockState p_i241989_2_, int p_i241989_3_) {
        super();
    ...
    public static final class FillerBlockType {
        public static final RuleTest MOBIAN_HEMATITE;

        static {
            MOBIAN_HEMATITE = new BlockMatchRuleTest(ModBlocks.HEMATITE.get());
        }
    }
}
