...
public class ClusteredStandingSkycapMushroomFeature extends Feature<NoFeatureConfig> {

    private final BlockState mushroomBlock;

    public ClusteredStandingSkycapMushroomFeature(Codec<NoFeatureConfig> configCodec, BlockState mushroomBlock) {
        super(configCodec);
