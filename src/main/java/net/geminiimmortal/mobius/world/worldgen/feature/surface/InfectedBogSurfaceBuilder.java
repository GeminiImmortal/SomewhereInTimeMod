...
public class InfectedBogSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

    public InfectedBogSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
        super(codec);
    }
    ...
    public void apply(Random random, IChunk iChunk, Biome biome, int x, int z, int height, double noise, BlockState defaultBlock, BlockState fluidBlock, int seaLevel, long seed, SurfaceBuilderConfig config) {
        ...
        for (int y = seaLevel - 10; y <= seaLevel + 5; y++) {
