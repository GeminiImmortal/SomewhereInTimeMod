...
public class FootmanEntity extends VindicatorEntity implements IAnimatable {
    ...
    public FootmanEntity(EntityType<? extends VindicatorEntity> type, World worldIn) {
        super(type, worldIn);
        this.dropExperience();
        this.maxUpStep = 1;
    ...
    public static boolean canMobSpawn(EntityType<? extends VindicatorEntity> entityType, IWorld world, SpawnReason reason, BlockPos pos, Random random) {
