...
public class EssenceChannelerContainer extends Container {
    ...
    public EssenceChannelerContainer(int windowId, World world, BlockPos pos,
                                     PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.ESSENCE_CHANNELER_CONTAINER.get(), windowId);
        ...
        if (tileEntity instanceof EssenceChannelerTileEntity) {
            this.fields = ((EssenceChannelerTileEntity) tileEntity).getFields();
