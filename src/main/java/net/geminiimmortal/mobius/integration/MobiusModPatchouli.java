...
public class MobiusModPatchouli {
    ...
    public static final RegistryObject<Item> IMPERIAL_DOCUMENT_0 = PATCHOULI_BOOKS.register("imperial_document_0", () -> new LoreEntry(new Item.Properties().tab(ItemGroup.TAB_MISC).stacksTo(1), LoreEntryType.IMPERIAL_DOCUMENT_0));
